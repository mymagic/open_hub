...
/**
 * This is the model class for table "interest_user2industry".
 *
 * The followings are the available columns in table 'interest_user2industry':
 ...
 */
 class InterestUser2industryBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('industry_id, interest_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('industry_id, interest_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return InterestUser2industry the static model class
	 */
	...
	protected function beforeSave()
	{
		if(parent::beforeSave()) {
			...
			// save as null if empty
					if(empty($this->industry_id) && $this->industry_id !==0) $this->industry_id = null;
