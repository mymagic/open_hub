...
class OS4GrowthModule extends WebModule
{
	...
	public function getAssetsUrl()
	{
		if (null === $this->_assetsUrl) {
			$this->_assetsUrl = Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('oS4Growth.assets'));
		}
	...
	public function getOrganizationActions($model, $realm = 'backend')
	{
		if ($realm == 'backend') {
			...
			$actions['oS4Growth'][] = array(
				'visual' => 'primary',
				'label' => 'Backend Action 1',
				'title' => 'Backend Action 1 short description',
				'url' => Yii::app()->controller->createUrl('/oS4Growth/backend/action1', array('id' => $model->id)),
			);
		} elseif ($realm == 'cpanel') {
			$actions['oS4Growth'][] = array(
				'visual' => 'primary',
				...
				'url' => Yii::app()->controller->createUrl('/oS4Growth/frontend/action1', array('id' => $model->id)),
			);
		}
	...
	public function getOrganizationFundingActions($model, $realm = 'backend')
	{
		...
		/*if ($realm == 'backend') {
			...
			$actions['oS4Growth'][] = array(
				...
				'label' => 'Backend Action 1',
				'title' => 'Backend Action 1 short description',
				'url' => Yii::app()->controller->createUrl('/oS4Growth/backend/action1', array('id' => $model->user_id)),
			);
		} */
	...
	public function getMemberActions($model, $realm = 'backend')
	{
		...
		/*if ($realm == 'backend') {
			...
			$actions['oS4Growth'][] = array(
				...
				'label' => 'Frontend Action 1',
				'title' => 'Frontend Action 1 short description',
				'url' => Yii::app()->controller->createUrl('/oS4Growth/frontend/action1', array('id' => $model->user_id)),
			);
		}*/
	...
	public function getBackendAdvanceSearch($controller, $searchFormModel)
	{
		...
		$result['oS4Growth'] = $searchModel->searchAdvance($searchFormModel->keyword);

		return array(
			'oS4Growth' => array(
				'tabLabel' => Yii::t('backend', 'Boilerplate'),
				'itemViewPath' => 'application.modules.oS4Growth.views.backend._view-oS4Growth-advanceSearch',
				'result' => $result['oS4Growth'],
			),
		);*/
	}
