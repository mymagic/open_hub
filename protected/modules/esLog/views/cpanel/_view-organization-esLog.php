<div class="row">
    <div class="col col-md-12">
        ...
        <div class="" id="vue-organization-esLog">
            <input type="hidden" name="organizationId" ref="organizationId" data-value="<?php echo $model->id ?>" />
    ...
    var vue = new Vue({
        ...
        data: {loading:false, page:'1', organizationId:'0', status:'fail', msg:'', meta:'', data:[], allLoaded:false},
        mounted: function () 
        {
            this.fetchData(0);
        },
        methods: 
        {
            ...
            {
                var self = this;
                self.organizationId = self.\$refs['organizationId'].attributes['data-value'].value;
