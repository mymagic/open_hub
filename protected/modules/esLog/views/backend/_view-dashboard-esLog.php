<div id="vue-esLog-backendDashboard">
...
<?php Yii::app()->clientScript->registerScript('backend-dashboard-esLog-vuejs', "
var vue = new Vue({
	el: '#vue-esLog-backendDashboard',
	data: {loading:false, page:'1', status:'fail', msg:'', meta:'', data:[], allLoaded:false},
	...
	methods: 
	{
		...
		fetchData: function(forceRefresh)
		{
			...
			{
				this.loading = true;
				$.get(baseUrl+'/esLog/backend/getSystemActFeed?page='+self.page, function( json ) 
				{
