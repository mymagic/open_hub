...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'code', array('required' => true)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'form_code', array('required' => true)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'form_code'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'stage', array('required' => true)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'stage'); ?>
		</div>
	</div>
