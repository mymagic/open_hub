...
<div class="modal fade" id="<?php echo $modelId ?>" role="dialog">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title"><?php echo Yii::t('f7', 'Add Organization') ?></h4>
        </div>
        <div class="modal-body">
            <div id="org-form-modal">
            <div id="org-alert-modal" style="display:none" class="alert alert-danger">
                <strong>Error!</strong> <?php echo Yii::t('f7', 'Organization name already exists. Please choose a different name.') ?>

            </div>
            <div class="form-group margin-bottom">
                    <label for="form-label org-name-modal"><?php echo Yii::t('f7', 'Organizatio Name') ?></label>
