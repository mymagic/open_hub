...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'is_multiple', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsBooleanList($model, 'is_multiple', array('nullable' => true)); ?>
		</div>
	</div>


	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'is_login_required', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsBooleanList($model, 'is_login_required', array('nullable' => true)); ?>
		</div>
	</div>
