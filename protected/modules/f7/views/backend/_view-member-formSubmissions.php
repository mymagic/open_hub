...
<div class="row">
    <div class="col col-md-12">
        ...
        <tr>
            ...
            <th class="text-center width-md"><?php echo yii::t('f7', 'Last Update') ?></th>
            <th class="text-center width-md"><?php echo yii::t('f7', 'Submitted On') ?></th>
            <th class="text-center width-md"><?php echo yii::t('core', 'Action') ?></th>
        </tr>
