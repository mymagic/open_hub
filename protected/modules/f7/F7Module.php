				...
				return array(
					array(
						...
						'items' => array(
							...
							array('label' => Yii::t('app', 'Intake'), 'url' => array('/f7/intake/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
							array('label' => Yii::t('app', 'Form'), 'url' => array('/f7/form/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
							array('label' => Yii::t('app', 'Submission') . ' <span class="label label-warning">dev</span>', 'url' => array('/f7/submission/admin'), 'visible' => Yii::app()->user->getState('isDeveloper')),
						),
					),
				);
