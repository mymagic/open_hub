...
/**
 * This is the model class for table "persona2intake".
 *
 * The followings are the available columns in table 'persona2intake':
			 * @property integer $persona_id
			 * @property integer $intake_id
 */
 class Persona2IntakeBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('persona_id, intake_id', 'required'),
			array('persona_id, intake_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('persona_id, intake_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return Persona2Intake the static model class
	 */
