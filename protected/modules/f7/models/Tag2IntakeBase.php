...
/**
 * This is the model class for table "tag2intake".
 *
 * The followings are the available columns in table 'tag2intake':
 ...
 * @property Tag $tag
 */
 class Tag2IntakeBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('tag_id, intake_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tag_id, intake_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return Tag2Intake the static model class
	 */
...
// save as null if empty
					if(empty($this->tag_id) && $this->tag_id !==0) $this->tag_id = null;
						if(empty($this->intake_id) && $this->intake_id !==0) $this->intake_id = null;
