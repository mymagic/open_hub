...
/**
 * This is the model class for table "startup_stage2intake".
 *
 * The followings are the available columns in table 'startup_stage2intake':
			 * @property integer $startup_stage_id
			 * @property integer $intake_id
 */
 class StartupStage2IntakeBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	public function rules()
 	{
 		...
 		return array(
			array('startup_stage_id, intake_id', 'required'),
			array('startup_stage_id, intake_id', 'numerical', 'integerOnly' => true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('startup_stage_id, intake_id', 'safe', 'on' => 'search'),
		);
 	}
 	 ...
 	 * @return StartupStage2Intake the static model class
 	 */
