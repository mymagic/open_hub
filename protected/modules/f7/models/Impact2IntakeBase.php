...
/**
 * This is the model class for table "impact2intake".
 *
 * The followings are the available columns in table 'impact2intake':
			 * @property integer $impact_id
			 * @property integer $intake_id
 */
 class Impact2IntakeBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	public function rules()
 	{
 		...
 		return array(
			array('impact_id, intake_id', 'required'),
			array('impact_id, intake_id', 'numerical', 'integerOnly' => true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('impact_id, intake_id', 'safe', 'on' => 'search'),
		);
 	}
 	...
 	public function search()
 	{
 		...
 		$criteria->compare('impact_id', $this->impact_id);
 	 ...
 	 * @return Impact2Intake the static model class
 	 */
