...
/**
 * This is the model class for table "sdg2intake".
 *
 * The followings are the available columns in table 'sdg2intake':
			 * @property integer $sdg_id
			 * @property integer $intake_id
 */
 class Sdg2IntakeBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	public function rules()
 	{
 		...
 		return array(
			array('sdg_id, intake_id', 'required'),
			array('sdg_id, intake_id', 'numerical', 'integerOnly' => true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('sdg_id, intake_id', 'safe', 'on' => 'search'),
		);
 	}
 	 ...
 	 * @return Sdg2Intake the static model class
 	 */
