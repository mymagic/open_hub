 ...
 class FormBase extends ActiveRecordBase
{
	...
	protected function beforeSave()
	{
		if(parent::beforeSave())
		{
			...
			if($this->json_structure == 'null') $this->json_structure = null;
			$this->json_stage = json_encode($this->jsonArray_stage);
			if($this->json_stage == 'null') $this->json_stage = null;

// save as null if empty
					if(empty($this->slug)) $this->slug = null;
						if(empty($this->json_structure)) $this->json_structure = null;
						if(empty($this->json_stage)) $this->json_stage = null;
	...
	{
		// boolean
		if($this->is_multiple != '' || $this->is_multiple != null) $this->is_multiple = intval($this->is_multiple);
		if($this->is_login_required != '' || $this->is_login_required != null) $this->is_login_required = intval($this->is_login_required);
