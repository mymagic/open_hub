...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'organization_code', array('nullable' => true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'eventbrite_account_id', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'eventbrite_account_id', array('nullable' => true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'eventbrite_oauth_secret', array('required' => false)); ?>
		<div class="col-sm-10">
