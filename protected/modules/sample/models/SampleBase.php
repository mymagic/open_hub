 ...
 class SampleBase extends ActiveRecordBase
{
	...
	public $sdate_posted, $edate_posted;
	...
	protected function beforeSave()
	{
		...
		{
			if($this->sample_zone_code == '') $this->sample_zone_code = NULL;
...
// save as null if empty
					if(empty($this->sample_group_id) && $this->sample_group_id !=0) $this->sample_group_id = null;
						if(empty($this->sample_zone_code)) $this->sample_zone_code = null;
						if(empty($this->html_content_en)) $this->html_content_en = null;
						if(empty($this->html_content_ms)) $this->html_content_ms = null;
						if(empty($this->html_content_zh)) $this->html_content_zh = null;
						if(empty($this->image_main)) $this->image_main = null;
						if(empty($this->file_backup)) $this->file_backup = null;
						if(empty($this->price_main)) $this->price_main = null;
						if(empty($this->gender)) $this->gender = null;
						if(empty($this->age) && $this->age !=0) $this->age = null;
						if(empty($this->csv_keyword)) $this->csv_keyword = null;
	...
	protected function afterFind()
	{
		...
		if($this->is_public != '' || $this->is_public != null) $this->is_public = intval($this->is_public);
		if($this->is_member != '' || $this->is_member != null) $this->is_member = intval($this->is_member);
		if($this->is_admin != '' || $this->is_admin != null) $this->is_admin = intval($this->is_admin);
