...
<header id="universal-header" class="z-40">
                ...
                <div class="flex items-center">
                    <?php if (count(Yii::app()->params['frontendLanguages']) > 1) : ?>
                        <?php foreach (Yii::app()->params['frontendLanguages'] as $langCode => $langTitle) : ?>
                            <div class="<?php echo (Yii::app()->language == $langCode) ? 'active' : ''; ?> mx-1">
                                <a href="<?php echo $this->createMultilanguageReturnUrl($langCode); ?>" title="<?php echo $langTitle; ?>"><img src="/images/languages/<?php echo strtolower($langCode); ?>.png" class="flag" alt="<?php echo $langTitle; ?>" width="24px" /></a>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
