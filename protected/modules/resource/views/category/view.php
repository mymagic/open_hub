...
$this->menu = array(
	...
	array('label' => Yii::t('app', 'Update ResourceCategory'), 'url' => array('/resource/category/update', 'id' => $model->id)),
	array('label' => Yii::t('app', 'Delete ResourceCategory'), 'url' => '#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->id), 'csrf' => Yii::app()->request->enableCsrfValidation, 'confirm' => Yii::t('core', 'Are you sure you want to delete this item?'))),
);
?>
