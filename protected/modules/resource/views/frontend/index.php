...
<?php 
  ...
  $thisPageMaxItem = intval($limit+($offset)); if($thisPageMaxItem > $totalItems) $thisPageMaxItem = $totalItems;
  $isFirstPage = $isLastPage = false; if($page==1) $isFirstPage=true; if($page==$maxPage) $isLastPage=true;
?>
