...
class HubResource
{
	...
	{
		if($value=='fund') return Yii::t('resource', 'Fund');
		else if($value=='space') return Yii::t('resource', 'Space');
		else if($value=='award') return Yii::t('resource', 'Award');
		else if($value=='program') return Yii::t('resource', 'Program');
		else if($value=='media') return Yii::t('resource', 'Media');
		else if($value=='legislation') return Yii::t('resource', 'Legislation');
		else if($value=='other') return Yii::t('resource', 'Others');
	}
