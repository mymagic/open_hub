...
$this->menu = array(
	array('label' => Yii::t('app', 'Manage CvExperience'), 'url' => array('/cv/experience/admin')),
	array('label' => Yii::t('app', 'Create CvExperience'), 'url' => array('/cv/experience/create')),
	array('label' => Yii::t('app', 'Update CvExperience'), 'url' => array('/cv/experience/update', 'id' => $model->id)),
);
?>
