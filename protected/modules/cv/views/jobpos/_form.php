...
<?php endif; ?>
	...
	<div class="form-group <?php echo $model->hasErrors('cv_jobpos_group_id') ? 'has-error' : '' ?>">
		<?php echo $form->bsLabelEx2($model, 'cv_jobpos_group_id'); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'cv_jobpos_group_id'); ?>
			<?php echo $form->bsError($model, 'cv_jobpos_group_id'); ?>
		</div>
	</div>
