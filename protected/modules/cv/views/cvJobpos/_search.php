...
<?php $form=$this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'cv_jobpos_group_id', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'cv_jobpos_group_id', array('nullable'=>true)); ?>
		</div>
	</div>
