...
<?php endif; ?>
	...
	<div class="form-group <?php echo $model->hasErrors('jobpos_id') ? 'has-error':'' ?>">
		<?php echo $form->bsLabelEx2($model,'jobpos_id'); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'jobpos_id'); ?>
			<?php echo $form->bsError($model,'jobpos_id'); ?>
		</div>
	</div>
	...
	<div class="form-group <?php echo $model->hasErrors('latlong_address_residential') ? 'has-error':'' ?>">
		<?php echo $form->bsLabelEx2($model,'latlong_address_residential'); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'latlong_address_residential'); ?>
			<?php echo $form->bsError($model,'latlong_address_residential'); ?>
		</div>
	</div>
	...
	<div class="form-group <?php echo $model->hasErrors('high_academy_experience_id') ? 'has-error':'' ?>">
		<?php echo $form->bsLabelEx2($model,'high_academy_experience_id'); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'high_academy_experience_id'); ?>
			<?php echo $form->bsError($model,'high_academy_experience_id'); ?>
		</div>
	</div>
