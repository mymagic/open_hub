...
$this->breadcrumbs=array(
	Yii::t('backend', 'Cv Jobpos Groups')=>array('index'),
...
$('.search-form form').submit(function(){
	$('#cv-jobpos-group-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('backend', 'Manage Cv Jobpos Groups'); ?></h1>


<div class="panel panel-default">
<div class="panel-heading">
	<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-cvJobposGroupSearch"><i class="fa fa-search"></i>&nbsp; Advanced Search</a></h4>
</div>
<div id="collapse-cvJobposGroupSearch" class="panel-collapse collapse">
