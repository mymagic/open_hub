 ...
 * The followings are the available columns in table 'collection_item':
			 * @property integer $id
			 * @property integer $collection_sub_id
 ...
 * @property CollectionSub $collectionSub
 */
 class CollectionItemBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('collection_sub_id, ref_id, table_name', 'required'),
			array('collection_sub_id, ref_id, date_added, date_modified', 'numerical', 'integerOnly'=>true),
			array('table_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, collection_sub_id, ref_id, table_name, json_extra, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
			// meta
	...
	public function relations()
	{
		...
		return array(
			'collectionSub' => array(self::BELONGS_TO, 'CollectionSub', 'collection_sub_id'),
	...
	public function attributeLabels()
	{
		$return = array(
		'id' => Yii::t('app', 'ID'),
		'collection_sub_id' => Yii::t('app', 'Collection Sub'),
	...
	public function search()
	{
		...
		$criteria->compare('collection_sub_id',$this->collection_sub_id);
