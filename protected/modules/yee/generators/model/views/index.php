...
<?php $form = $this->beginWidget('CCodeForm', array('model' => $model)); ?>
	...
	<div class="row sticky">
		...
		<div class="tooltip">
			If this model belongs to a specific module, insert the module name here. eg: mdecMsc
		</div>
		<?php echo $form->error($model, 'moduleName'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model, 'buildNeo4j'); ?>
		<?php echo $form->checkBox($model, 'buildNeo4j'); ?>
		<div class="tooltip">
			Whether Neo4J OGM should be generated for the model class.
		</div>
		<?php echo $form->error($model, 'buildNeo4j'); ?>
	</div>
	<div class="row">
	...
	<div class="row">
		<?php echo $form->labelEx($model, 'buildExtendClass'); ?>
		<?php echo $form->checkBox($model, 'buildExtendClass'); ?>
		<div class="tooltip">
			Override the extended class of this model, where all user customize code sit in.
		</div>
		<?php echo $form->error($model, 'buildExtendClass'); ?>
	</div>
	<div class="row">
