...
$this->menu = array(
	...
	array(
		'label' => Yii::t('challenge', 'Update Challenge'), 'url' => array('/challenge/challenge/update', 'id' => $model->id), 'visible' => HUB::roleCheckerAction(Yii::app()->user->getState('rolesAssigned'), Yii::app()->controller, 'update')
	),
	/*array(
