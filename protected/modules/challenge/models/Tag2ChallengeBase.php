...
/**
 * This is the model class for table "tag2challenge".
 *
 * The followings are the available columns in table 'tag2challenge':
 ...
 * @property Tag $tag
 */
 class Tag2ChallengeBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('tag_id, challenge_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tag_id, challenge_id', 'safe', 'on'=>'search'),
		);
	...
	public function search()
	{
		...
		$criteria->compare('challenge_id',$this->challenge_id);
	 ...
	 * @return Tag2Challenge the static model class
	 */
...
// save as null if empty
					if(empty($this->tag_id) && $this->tag_id !==0) $this->tag_id = null;
						if(empty($this->challenge_id) && $this->challenge_id !==0) $this->challenge_id = null;
