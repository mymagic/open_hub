 ...
 class ChallengeBase extends ActiveRecordBase
{
	...
	public $sdate_open, $edate_open;
	public $sdate_close, $edate_close;
	public $sdate_submit, $edate_submit;
	public $sdate_process, $edate_process;
...
// save as null if empty
					if(empty($this->text_short_description)) $this->text_short_description = null;
						...
						if(empty($this->image_cover)) $this->image_cover = null;
						if(empty($this->image_header)) $this->image_header = null;
						if(empty($this->url_video)) $this->url_video = null;
						if(empty($this->url_application_form)) $this->url_application_form = null;
						if(empty($this->html_deliverable)) $this->html_deliverable = null;
						if(empty($this->html_criteria)) $this->html_criteria = null;
						if(empty($this->prize_title)) $this->prize_title = null;
						if(empty($this->html_prize_detail)) $this->html_prize_detail = null;
						if(empty($this->date_open) && $this->date_open !==0) $this->date_open = null;
						if(empty($this->date_close) && $this->date_close !==0) $this->date_close = null;
						if(empty($this->ordering) && $this->ordering !==0) $this->ordering = null;
						if(empty($this->text_remark)) $this->text_remark = null;
						if(empty($this->json_extra)) $this->json_extra = null;
						if(empty($this->timezone)) $this->timezone = null;
						if(empty($this->process_by)) $this->process_by = null;
						if(empty($this->date_submit) && $this->date_submit !==0) $this->date_submit = null;
						if(empty($this->date_process) && $this->date_process !==0) $this->date_process = null;
	...
	protected function afterFind()
	{
		...
		if($this->is_publish != '' || $this->is_publish != null) $this->is_publish = intval($this->is_publish);
