...
/**
 * This is the model class for table "industry2challenge".
 *
 * The followings are the available columns in table 'industry2challenge':
			 * @property integer $industry_id
			 * @property integer $challenge_id
 */
 class Industry2ChallengeBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	public function rules()
 	{
 		...
 		return array(
			array('industry_id, challenge_id', 'required'),
			array('industry_id, challenge_id', 'numerical', 'integerOnly' => true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('industry_id, challenge_id', 'safe', 'on' => 'search'),
		);
 	}
 	 ...
 	 * @return Industry2Challenge the static model class
 	 */
