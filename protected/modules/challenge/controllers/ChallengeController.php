...
class ChallengeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Challenge']))
		{
			...
			if(!empty($model->date_open)) $model->date_open = strtotime($model->date_open);
			if(!empty($model->date_close)) $model->date_close = strtotime($model->date_close);
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Challenge'])) $model->attributes=$_GET['Challenge'];
