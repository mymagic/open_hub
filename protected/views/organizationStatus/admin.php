...
$('.search-form form').submit(function(){
	$('#organization-status-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('backend', 'Manage Organization Statuses'); ?></h1>


<div class="panel panel-default">
<div class="panel-heading">
	<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-organizationStatusSearch"><i class="fa fa-search"></i>&nbsp; Advanced Search</a></h4>
</div>
