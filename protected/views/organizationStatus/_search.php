...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php $this->widget('application.components.widgets.OrganizationSelector', array('form' => $form, 'model' => $model, 'attribute' => 'organization_id', 'urlAjax' => $this->createUrl('organizationStatus/ajaxOrganization'), 'htmlOptions' => array('style' => 'width:100%'))) ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'date_reported', array('required' => false)); ?>
		<label class="control-label col-sm-1"><?php echo Yii::t('backend', 'Start') ?></label>
		<div class="col-sm-4">
			<?php echo $form->bsDateTextField($model, 'sdate_reported', array('nullable' => true, 'class' => 'dateRange-start')); ?>
		</div>
		<label class="control-label col-sm-1"><?php echo Yii::t('backend', 'End') ?></label>
		<div class="col-sm-4">
			<?php echo $form->bsDateTextField($model, 'edate_reported', array('nullable' => true, 'class' => 'dateRange-end')); ?>
		</div>
	</div>
