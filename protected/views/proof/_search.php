...
<?php $form=$this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'ref_table', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsEnumDropDownList($model, 'ref_table', array('nullable'=>true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'ref_id', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'ref_id', array('nullable'=>true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'datatype', array('required'=>false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'datatype_value', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'datatype_value'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'note', array('required'=>false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'user_username', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'user_username'); ?>
		</div>
	</div>
