...
<?php Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl . '/vendor/webflow/javascript/webflow.js', CClientScript::POS_END); ?>
...
?>
<?php Yii::app()->getClientScript()->registerCssFile(Yii::app()->baseUrl . '/vendor/webflow/css/webflow.css'); ?>
