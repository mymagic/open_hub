...
$this->menu = array(
	...
	array(
		'label' => Yii::t('app', 'Update IndustryKeyword'), 'url' => array('/industryKeyword/update', 'id' => $model->id),
		'visible' => HUB::roleCheckerAction(Yii::app()->user->getState("rolesAssigned"), Yii::app()->controller, 'update')
	),
	array(
		'label' => Yii::t('app', 'Delete IndustryKeyword'), 'url' => '#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->id), 'csrf' => Yii::app()->request->enableCsrfValidation, 'confirm' => Yii::t('core', 'Are you sure you want to delete this item?')),
