...
$this->breadcrumbs = array(
	Yii::t('backend', 'Event Groups') => array('index'),
...
$('.search-form form').submit(function(){
	$('#event-group-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel-heading">
	<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-eventGroupSearch"><i class="fa fa-search"></i>&nbsp; Advanced Search</a></h4>
</div>
<div id="collapse-eventGroupSearch" class="panel-collapse collapse">
