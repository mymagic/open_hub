...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'year_reported', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'year_reported'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'amount_profit', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'amount_profit'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'amount_profit_before_tax', array('required' => false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsTextField($model, 'amount_profit_before_tax'); ?>
		</div>
	</div>
