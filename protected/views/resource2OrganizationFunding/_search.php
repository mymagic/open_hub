...
<?php $form=$this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'resource_id', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'resource_id', array('nullable'=>true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'organization_funding_id', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'organization_funding_id', array('nullable'=>true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php echo $form->bsForeignKeyDropDownList($model, 'as_role_code', array('nullable'=>true)); ?>
		</div>
	</div>
