<div class="panel panel-default" id="vue-systemLog">
...
<?php Yii::app()->clientScript->registerScript('backend-dashboard-systemLog-vuejs', "
var vue = new Vue({
	el: '#vue-systemLog',
	...
	methods: 
	{
		...
		fetchData: function(forceRefresh)
		{
			...
			{
				this.loading = true;
				$.get(baseUrl+'/backend/getSystemLog?page='+self.page, function( json ) 
				{
