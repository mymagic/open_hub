...
$this->breadcrumbs=array(
	...
	Yii::t('backend', 'Manage Revenue Milestone'),
);

$this->menu=array(
	array('label'=>Yii::t('app','Manage All Milestone'), 'url'=>array('/milestone/admin')),
	array('label'=>Yii::t('app','Create Milestone'), 'url'=>array('/milestone/create', 'presetCode'=>'revenue')),
);
...
<h1><?php echo Yii::t('backend', 'Manage Revenue Milestones'); ?></h1>
...
<?php $this->widget('application.components.widgets.GridView', array(
	...
	'columns'=>array(
		...
		'title',
		array('name'=>'preset_code', 'cssClassExpression'=>'foreignKey', 'value'=>'$data->formatEnumPresetCode($data->preset_code)', 'filter'=>false),
