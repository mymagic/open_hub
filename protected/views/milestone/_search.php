...
<?php $form=$this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'username', array('required'=>false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'preset_code', array('required'=>false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'is_star', array('required'=>false)); ?>
		<div class="col-sm-10">
			<?php echo $form->bsBooleanList($model, 'is_star', array('nullable'=>true)); ?>
		</div>
	</div>
