...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php $this->widget('application.components.widgets.OrganizationSelector', array('form' => $form, 'model' => $model, 'attribute' => 'organization_id', 'urlAjax' => $this->createUrl('organizationFunding/ajaxOrganization'), 'htmlOptions' => array('style' => 'width:100%'))) ?>
		</div>
	</div>
