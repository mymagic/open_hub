...
$this->menu=array(
	...
	array('label'=>Yii::t('app','Update Industry'), 'url'=>array('/industry/update', 'id'=>$model->id)),
	array('label'=>Yii::t('app','Create IndustryKeyword'), 'url'=>array('/industryKeyword/createBulk', 'industryCode'=>$model->code)),
);
?>
