...
$this->breadcrumbs=array(
	Yii::t('backend', 'Impacts')=>array('index'),
...
$('.search-form form').submit(function(){
	$('#impact-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('backend', 'Manage Impacts'); ?></h1>


<div class="panel panel-default">
<div class="panel-heading">
	<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-impactSearch"><i class="fa fa-search"></i>&nbsp; Advanced Search</a></h4>
</div>
<div id="collapse-impactSearch" class="panel-collapse collapse">
