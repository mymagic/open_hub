...
<?php $form = $this->beginWidget('ActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'charge_to', array('required' => false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'charge_to_code', array('required' => false)); ?>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<?php echo $form->bsLabelFx2($model, 'date_expired', array('required' => false)); ?>
		<label class="control-label col-sm-1"><?php echo Yii::t('backend', 'Start') ?></label>
		<div class="col-sm-4">
			<?php echo $form->bsDateTextField($model, 'sdate_expired', array('nullable' => true, 'class' => 'dateRange-start')); ?>
		</div>
		<label class="control-label col-sm-1"><?php echo Yii::t('backend', 'End') ?></label>
		<div class="col-sm-4">
			<?php echo $form->bsDateTextField($model, 'edate_expired', array('nullable' => true, 'class' => 'dateRange-end')); ?>
		</div>
	</div>
