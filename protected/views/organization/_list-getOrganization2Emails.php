<div class="view">
	...
	<p class="org-listowner"><a href="<?php echo $this->createUrl('organization/deleteOrganization2Email', array('id'=>$data->id, 'realm'=>$realm))?>" class="text-danger"><?php echo Html::faIcon('fa-trash') ?></a>&nbsp; <?php echo Html::encodeDisplay($data->user_email); ?></p>
</div>
