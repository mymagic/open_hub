	...
	<div class="panel panel-default">
		...
		<div class="crud-view"><?php $this->widget('application.components.widgets.DetailView', array(
			...
			'attributes'=>array(
				...
				array('name'=>'ic_number', 'visible'=>Yii::app()->user->isSensitiveDataAdmin),
				array('name'=>'mobile_number', 'visible'=>Yii::app()->user->isSensitiveDataAdmin),
...
<div class="col col-sm-5">
	...
	<?php Yii::app()->clientScript->registerScript('backend-individual-view',
