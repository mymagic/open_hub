...
/**
 * This is the model class for table "tag2resource".
 *
 * The followings are the available columns in table 'tag2resource':
 ...
 * @property Tag $tag
 */
 class Tag2ResourceBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('tag_id, resource_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tag_id, resource_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return Tag2Resource the static model class
	 */
...
// save as null if empty
					if(empty($this->tag_id) && $this->tag_id !==0) $this->tag_id = null;
						if(empty($this->resource_id) && $this->resource_id !==0) $this->resource_id = null;
