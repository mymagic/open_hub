 ...
 class EventOwnerBase extends ActiveRecordBase
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('event_code, organization_code', 'length', 'max'=>64),
			array('department', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, event_code, organization_code, department, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
			// meta
