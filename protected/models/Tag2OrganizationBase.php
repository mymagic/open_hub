...
/**
 * This is the model class for table "tag2organization".
 *
 * The followings are the available columns in table 'tag2organization':
 ...
 * @property Tag $tag
 */
 class Tag2OrganizationBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('tag_id, organization_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tag_id, organization_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return Tag2Organization the static model class
	 */
