 ...
 *
 * The followings are the available columns in table 'impact':
			 * @property integer $id
 ...
 */
 class ImpactBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	{
		$this->uploadPath = Yii::getPathOfAlias('uploads').DIRECTORY_SEPARATOR.'impact';
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, code, title, image_cover, is_active, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'organizations' => array(self::MANY_MANY, 'Organization', 'impact2organization(impact_id, organization_id)'),
		);
	}
	 ...
	 * @return Impact the static model class
	 */
	...
	{
		$exists = Impact::model()->find('code=:code', array(':code'=>$code));
