...
/**
 * This is the model class for table "organization2Email".
 *
 * The followings are the available columns in table 'organization2Email':
			 * @property integer $id
 ...
 */
 class Organization2EmailBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	{
 		$this->uploadPath = Yii::getPathOfAlias('uploads') . DIRECTORY_SEPARATOR . 'organization2Email';
 	...
 	public function rules()
 	{
 		...
 		return array(
			...
			array('id, organization_id, user_email, status, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on' => 'search'),
		);
 	}
 	 ...
 	 * @return Organization2Email the static model class
 	 */
 	...
 	public function getEnumStatus($isNullable = false, $is4Filter = false)
 	{
 		...
 		$result[] = array('code' => 'approve', 'title' => $this->formatEnumStatus('approve'));
 	...
 	{
 		switch ($code) {
			case 'approve': {return Yii::t('app', 'Approve'); break;}
