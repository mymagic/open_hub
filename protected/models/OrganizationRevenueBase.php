...
/**
 * This is the model class for table "organization_revenue".
 *
 * The followings are the available columns in table 'organization_revenue':
			 * @property integer $id
			 * @property integer $organization_id
			 * @property integer $year_reported
			 ...
			 * @property string $amount_profit_before_tax
 *
 * The followings are the available model relations:
 * @property Organization $organization
 */
 class OrganizationRevenueBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('organization_id, year_reported, amount', 'required'),
			array('organization_id, year_reported, date_added, date_modified, is_active', 'numerical', 'integerOnly'=>true),
			array('amount, amount_profit, amount_profit_before_tax', 'length', 'max'=>20),
			array('source', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, organization_id, year_reported, amount, source, date_added, date_modified, is_active, amount_profit, amount_profit_before_tax, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	...
	public function attributeLabels()
	{
		...
		'year_reported' => Yii::t('app', 'Year Reported'),
		'amount' => Yii::t('app', 'Amount'),
		'source' => Yii::t('app', 'Source'),
		'date_added' => Yii::t('app', 'Date Added'),
		'date_modified' => Yii::t('app', 'Date Modified'),
		'is_active' => Yii::t('app', 'Is Active'),
		'amount_profit' => Yii::t('app', 'Amount Profit'),
		'amount_profit_before_tax' => Yii::t('app', 'Amount Profit Before Tax'),
		);
	...
	public function search()
	{
		...
		$criteria->compare('year_reported',$this->year_reported);
		...
		$criteria->compare('amount_profit',$this->amount_profit,true);
		$criteria->compare('amount_profit_before_tax',$this->amount_profit_before_tax,true);
	...
	public function toApi($params='')
	{
		...
		$return = array(
			...
			'yearReported' => $this->year_reported,
			'amount' => $this->amount,
			'source' => $this->source,
			...
			'amountProfit' => $this->amount_profit,
			'amountProfitBeforeTax' => $this->amount_profit_before_tax,
		...
		if(parent::beforeSave()) {
			...
			// save as null if empty
					if(empty($this->source)) $this->source = null;
						if(empty($this->amount_profit)) $this->amount_profit = null;
						if(empty($this->amount_profit_before_tax)) $this->amount_profit_before_tax = null;
