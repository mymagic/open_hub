...
/**
 * This is the model class for table "resource2organization_funding".
 *
 * The followings are the available columns in table 'resource2organization_funding':
			 * @property integer $id
			 * @property integer $resource_id
			 * @property integer $organization_funding_id
			 * @property string $as_role_code
			 * @property integer $date_added
			 * @property integer $date_modified
 *
 * The followings are the available model relations:
 * @property OrganizationFunding $organizationFunding
 * @property Resource $resource
 */
 class Resource2OrganizationFundingBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	{
 		return 'resource2organization_funding';
 	}
 	...
 	public function rules()
 	{
 		...
 		return array(
			array('resource_id, organization_funding_id, as_role_code', 'required'),
			array('resource_id, organization_funding_id, date_added, date_modified', 'numerical', 'integerOnly' => true),
			array('as_role_code', 'length', 'max' => 64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, resource_id, organization_funding_id, as_role_code, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on' => 'search'),
		);
 	}
 	...
 	public function relations()
 	{
 		...
 		return array(
			'organizationFunding' => array(self::BELONGS_TO, 'OrganizationFunding', 'organization_funding_id'),
 	...
 	public function attributeLabels()
 	{
		...
		'organization_funding_id' => Yii::t('app', 'Organization Funding'),
 	...
 	public function search()
 	{
 		...
 		$criteria->compare('organization_funding_id', $this->organization_funding_id);
 	...
 	public function toApi($params = '')
 	{
 		...
 		$return = array(
			...
			'organizationFundingId' => $this->organization_funding_id,
 	 ...
 	 * @return Resource2OrganizationFunding the static model class
 	 */
