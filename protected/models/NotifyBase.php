 ...
 */
 class NotifyBase extends ActiveRecordBase
 {
 	...
 	public $receiverMobileNo;
 	public $receiverDeviceId;
 	public $receiverDeviceToken;
 	public $receiverDeviceType;
 	...
 	public function getEnumSenderType($isNullable = false, $is4Filter = false)
 	{
 		...
 		if ($isNullable) {
 			$result[] = array('code' => '', 'title' => $this->formatEnumSenderType(''));
 		}
 	...
 	public function getEnumReceiverType($isNullable = false, $is4Filter = false)
 	{
 		...
 		if ($isNullable) {
 			$result[] = array('code' => '', 'title' => $this->formatEnumReceiverType(''));
 		}
