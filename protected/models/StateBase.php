 ...
 */
 class StateBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	{
		$this->uploadPath = Yii::getPathOfAlias('uploads').DIRECTORY_SEPARATOR.'state';
	...
	public function rules()
	{
		...
		return array(
			array('code, country_code, title', 'required'),
			...
			array('id, code, country_code, title, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'experiences' => array(self::HAS_MANY, 'Experience', 'state_code'),
			'portfolios' => array(self::HAS_MANY, 'Portfolio', 'state_code'),
			'programs' => array(self::HAS_MANY, 'Program', 'state_code'),
	...
	{
		$exists = State::model()->find('code=:code', array(':code'=>$code));
