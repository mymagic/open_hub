...
/**
 * This is the model class for table "industry_keyword".
 *
 * The followings are the available columns in table 'industry_keyword':
			 * @property integer $id
 ...
 */
 class IndustryKeywordBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('industry_code, title', 'required'),
			array('date_added, date_modified', 'numerical', 'integerOnly'=>true),
			array('industry_code', 'length', 'max'=>64),
			array('title', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, industry_code, title, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	...
	public function relations()
	{
		...
		return array(
			'industry' => array(self::BELONGS_TO, 'Industry', 'industry_code'),
	...
	public function attributeLabels()
	{
		$return = array(
		'id' => Yii::t('app', 'ID'),
		'industry_code' => Yii::t('app', 'Industry Code'),
	...
	public function search()
	{
		...
		$criteria->compare('industry_code',$this->industry_code,true);
	 ...
	 * @return IndustryKeyword the static model class
	 */
