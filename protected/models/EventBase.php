...
return parent::afterSave();
	...
	protected function beforeSave()
	{
		if(parent::beforeSave()) {
			if($this->event_group_code == '') $this->event_group_code = NULL;
			if($this->vendor_code == '') $this->vendor_code = NULL;
			if($this->address_country_code == '') $this->address_country_code = NULL;
			if($this->address_state_code == '') $this->address_state_code = NULL;
			...
			// save as null if empty
					if(empty($this->event_group_code)) $this->event_group_code = null;
						if(empty($this->text_short_desc)) $this->text_short_desc = null;
						if(empty($this->url_website)) $this->url_website = null;
						if(empty($this->date_ended) && $this->date_ended !==0) $this->date_ended = null;
						if(empty($this->is_paid_event) && $this->is_paid_event !==0) $this->is_paid_event = null;
						if(empty($this->genre)) $this->genre = null;
						if(empty($this->funnel)) $this->funnel = null;
						if(empty($this->vendor_code)) $this->vendor_code = null;
						if(empty($this->at)) $this->at = null;
						if(empty($this->address_country_code)) $this->address_country_code = null;
						if(empty($this->address_state_code)) $this->address_state_code = null;
						...
						if(empty($this->json_original)) $this->json_original = null;
						if(empty($this->json_extra)) $this->json_extra = null;
						if(empty($this->is_survey_enabled) && $this->is_survey_enabled !==0) $this->is_survey_enabled = null;
	...
	{
		// boolean
		if($this->is_paid_event != '' || $this->is_paid_event != null) $this->is_paid_event = intval($this->is_paid_event);
		if($this->is_cancelled != '' || $this->is_cancelled != null) $this->is_cancelled = intval($this->is_cancelled);
		if($this->is_active != '' || $this->is_active != null) $this->is_active = intval($this->is_active);
		if($this->is_survey_enabled != '' || $this->is_survey_enabled != null) $this->is_survey_enabled = intval($this->is_survey_enabled);
