 ...
 * @property IndustryKeyword[] $industryKeywords
 * @property Resource[] $resources
 */
 class IndustryBase extends ActiveRecordBase
 {
 	public $uploadPath;
 	...
 	public function rules()
 	{
 		...
 		return array(
			...
			array('id, code, slug, title, is_active, date_added, date_modified, title_en, title_ms, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on' => 'search'),
		);
 	}
 	...
 	public function relations()
 	{
 		...
 		return array(
			'events' => array(self::MANY_MANY, 'Event', 'event2industry(industry_id, event_id)'),
			'intakes' => array(self::MANY_MANY, 'Intake', 'industry2intake(industry_id, intake_id)'),
			'organizations' => array(self::MANY_MANY, 'Organization', 'industry2organization(industry_id, organization_id)'),
			'industryKeywords' => array(self::HAS_MANY, 'IndustryKeyword', 'industry_code'),
			'resources' => array(self::MANY_MANY, 'Resource', 'resource2industry(industry_id, resource_id)'),
		);
 	}
 	...
 	{
 		$exists = Industry::model()->find('code=:code', array(':code' => $code));
 		if ($exists === null) {
 			return false;
 		}
