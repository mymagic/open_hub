 ...
 * The followings are the available columns in table 'registry':
			 ...
			 * @property string $the_value
			 * @property integer $date_added
			 * @property integer $date_modified
 */
 class RegistryBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			...
			array('the_value', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, code, the_value, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	...
	public function search()
	{
		...
		$criteria->compare('the_value',$this->the_value,true);
...
// save as null if empty
					if(empty($this->the_value)) $this->the_value = null;
	...
	{
		$exists = Registry::model()->find('code=:code', array(':code'=>$code));
