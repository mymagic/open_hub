 ...
 * The followings are the available columns in table 'service':
			 ...
			 * @property integer $is_bookmarkable
 ...
 * @property User[] $users
 */
 class ServiceBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_bookmarkable, is_active, date_added, date_modified', 'numerical', 'integerOnly'=>true),
			array('slug', 'length', 'max'=>32),
			array('title', 'length', 'max'=>100),
			array('text_oneliner', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, slug, title, text_oneliner, is_bookmarkable, is_active, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::MANY_MANY, 'User', 'service2user(service_id, user_id)'),
	...
	public function attributeLabels()
	{
		...
		'is_bookmarkable' => Yii::t('app', 'Is Bookmarkable'),
	...
	public function search()
	{
		...
		$criteria->compare('is_bookmarkable',$this->is_bookmarkable);
	...
	public function toApi($params='')
	{
		...
		$return = array(
			...
			'isBookmarkable' => $this->is_bookmarkable,
	...
	public function scopes()
    {
		...
		(
			...
			'isBookmarkable' => array('condition'=>'t.is_bookmarkable = 1'),
			'isActive' => array('condition'=>'t.is_active = 1'),
...
// save as null if empty
			if(empty($this->text_oneliner) && $this->text_oneliner !=0) $this->text_oneliner = null;
	...
	{
		// boolean
		if($this->is_bookmarkable != '' || $this->is_bookmarkable != null) $this->is_bookmarkable = intval($this->is_bookmarkable);
