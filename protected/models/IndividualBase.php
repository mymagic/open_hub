 ...
 class IndividualBase extends ActiveRecordBase
{
	...
	protected function beforeSave()
	{
		if(parent::beforeSave())
		{
			...
			if($this->can_code == '') $this->can_code = NULL;
...
// save as null if empty
					if(empty($this->gender)) $this->gender = null;
						if(empty($this->image_photo)) $this->image_photo = null;
						if(empty($this->country_code)) $this->country_code = null;
						if(empty($this->state_code)) $this->state_code = null;
						if(empty($this->ic_number)) $this->ic_number = null;
						if(empty($this->text_address_residential)) $this->text_address_residential = null;
						if(empty($this->mobile_number)) $this->mobile_number = null;
						if(empty($this->can_code) && $this->can_code !==0) $this->can_code = null;
