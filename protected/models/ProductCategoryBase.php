 ...
 */
 class ProductCategoryBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	{
		$this->uploadPath = Yii::getPathOfAlias('uploads').DIRECTORY_SEPARATOR.'product_category';
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, text_short_description, image_cover, ordering, is_active, date_added, date_modified, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	}
