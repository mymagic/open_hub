...
// save as null if empty
			...
			if(empty($this->organization_name) && $this->organization_name !=0) $this->organization_name = null;
			if(empty($this->date_action) && $this->date_action !=0) $this->date_action = null;
