 ...
 class SeolyticBase extends ActiveRecordBase
 {
 	...
 	protected function beforeSave()
 	{
 		if (parent::beforeSave()) {
 			...
 			if (empty($this->title_ms)) {
 				$this->title_ms = null;
 			}
 			if (empty($this->title_zh)) {
 				$this->title_zh = null;
 			}
 			if (empty($this->description_en)) {
 				$this->description_en = null;
 			}
 			if (empty($this->description_ms)) {
 				$this->description_ms = null;
 			}
 			if (empty($this->description_zh)) {
 				$this->description_zh = null;
 			}
 			...
 			if (empty($this->css_header)) {
 				$this->css_header = null;
 			}
 			if (empty($this->json_meta)) {
 				$this->json_meta = null;
 			}
