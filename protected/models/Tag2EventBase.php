...
/**
 * This is the model class for table "tag2event".
 *
 * The followings are the available columns in table 'tag2event':
 ...
 * @property Tag $tag
 */
 class Tag2EventBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			array('tag_id, event_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tag_id, event_id', 'safe', 'on'=>'search'),
		);
	 ...
	 * @return Tag2Event the static model class
	 */
