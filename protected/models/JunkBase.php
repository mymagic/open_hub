...
/**
 * This is the model class for table "junk".
 *
 * The followings are the available columns in table 'junk':
			 * @property integer $id
 ...
 */
 class JunkBase extends ActiveRecordBase
{
	public $uploadPath;
	 ...
	 * @return Junk the static model class
	 */
	...
	{
		$exists = Junk::model()->find('code=:code', array(':code' => $code));
		if($exists===null) {
			return false;
		}
