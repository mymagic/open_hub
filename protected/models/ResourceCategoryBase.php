 ...
 */
 class ResourceCategoryBase extends ActiveRecordBase
{
	public $uploadPath;
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, typefor, title, slug, is_active, date_added, date_modified, title_en, title_ms, sdate_added, edate_added, sdate_modified, edate_modified', 'safe', 'on'=>'search'),
		);
	...
	public function relations()
	{
		...
		return array(
			'resources' => array(self::MANY_MANY, 'Resource', 'resource2resource_category(resource_category_id, resource_id)'),
	...
	public function search()
	{
		...
		$criteria->compare('typefor',$this->typefor,true);
