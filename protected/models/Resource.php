...
class Resource extends ResourceBase
{
	...
	protected function beforeSave()
	{
		...
		if($this->is_blocked==1) $this->is_active=0;
	...
	public function search($params=null)
	{
		...
		if(!empty($this->searchOrganizationId)) $criteria->compare('organizations.id', $this->searchOrganizationId, false, $params['compareOperator'] );
