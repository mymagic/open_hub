	...
	protected function beforeSave()
	{
		if(parent::beforeSave()) {
			...
			// save as null if empty
					if(empty($this->text_short_description_en)) $this->text_short_description_en = null;
						if(empty($this->text_short_description_ms)) $this->text_short_description_ms = null;
