...
*/
class StartupStageController extends Controller
{
	/**
	...
	{
		$this->redirect(array('startup-stage/admin'));
	}
	 ...
	 * @return StartupStage the loaded model
	 ...
	 * @param StartupStage $model the model to be validated
	 */
