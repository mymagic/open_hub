...
*/
class SeolyticController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create', 'update', 'admin' and 'delete' actions
				...
				// isAdmin does not allow to access Site menu
	...
	{
		$this->redirect(array('seolytic/admin'));
	}
	 ...
	 * @return Seolytic the loaded model
	 ...
	 * @param Seolytic $model the model to be validated
	 */
