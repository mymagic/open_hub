    ...
    protected function initBackendMenu()
    {
        ...
        $navItems = array(
            ...
            array(
                ...
                'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => 'dropdown'),
                'items' => array(
                    array('label' => Yii::t('app', 'Product Category'), 'url' => array('/productCategory/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'Cluster'), 'url' => array('/cluster/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'Persona'), 'url' => array('/persona/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'Industry'), 'url' => array('/industry/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'Impact'), 'url' => array('/impact/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'SDG'), 'url' => array('/sdg/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
                    array('label' => Yii::t('app', 'Startup Stages'), 'url' => array('/startupStage/admin'), 'visible' => Yii::app()->user->getState('accessBackend') == true),
